...
public class pregunta {
    ...
    String[][] matriz = new String[][]{
            ...
            {"Casanare", "Yopal","El departamento del Casanare ubicado en la región central de Colombia, en la llanura oriental. Limita al norte con los departamentos de Arauca y Boyacá, al este con Venezuela, al sur con el departamento de Meta y al oeste con los departamentos de Cundinamarca, Santander y Norte de Santander."},
